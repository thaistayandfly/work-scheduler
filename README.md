...
- **Your details and rates** (the gear): which calendar the board writes to, your full name (in the report's language: Hebrew letters for a Hebrew report, English letters for an English one), the company email, the report language and your four rates. Everything but the calendar is saved in your pay sheet's Settings tab, so it needs Google Drive connected first. One **Save details** button, and it puts you back on the screen you came from.
